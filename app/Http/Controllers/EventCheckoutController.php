...
class EventCheckoutController extends Controller
{
    ...
    public function postValidateOrder(Request $request, $event_id)
    {
        ...
        'first_min_partial_amount'=>100, 'description' => 'Event '.$ticket_order['tickets'][0]['ticket']->event->title, 'customer' => array('name'=>$request_data['order_first_name'],
        'email' => $request_data['order_email']),  'notify'=>array('email'=>true) ,
