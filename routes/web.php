...
Route::group(
    ...
    Route::group(['middleware' => ['auth', 'first.run']], function () {
        ...
        Route::group(['prefix' => 'organiser'], function () {
            ...
            Route::get('{organiser_id}/category-event',
                [OrganiserController::class, 'showCategory']
            )->name('showCategory');

            Route::get('{organiser_id}/subscriber',
            [OrganiserController::class, 'listSubscriber']
            )->name('listSubscriber');


            Route::get('{organiser_id}/listnews',
            [OrganiserController::class, 'listNews']
            )->name('listNews');

            Route::get('{organiser_id}/addCategory',
            [OrganiserController::class, 'addCategory']
            )->name('addCategory');
           
            Route::get('{organiser_id}/addnews',
            [OrganiserController::class, 'addnews']
            )->name('addnews');
