<aside class="sidebar sidebar-left sidebar-menu">
    <section class="content">
        ...
        <ul id="nav" class="topmenu">
            ...
            <li class="{{ Request::is('*categoryEvent*') ? 'active' : '' }}">
                <a href="{{route('showCategory', array('organiser_id' => $organiser->id))}}">
                    <span class="figure"><i class="ico-calendar"></i></span>
                    <span class="text">Event Cateogry</span>
                </a>
            </li>
             <li class="{{ Request::is('*categoryEvent*') ? 'active' : '' }}">
                <a href="{{route('listNews', array('organiser_id' => $organiser->id))}}">
                    <span class="figure"><i class="ico-calendar"></i></span>
                    <span class="text">News</span>
                </a>
            </li>

            <li class="{{ Request::is('*listSubscriber*') ? 'active' : '' }}">
                <a href="{{route('listSubscriber', array('organiser_id' => $organiser->id))}}">
                    <span class="figure"><i class="ico-calendar"></i></span>
